    ...
    public class SeedDataController : ControllerBase
    {
        ...
        public async Task<IActionResult> SeedSampleStudents()
        {
            try
            {
                ...
                {
                    return Ok(new { message = $"Database đã có {existingStudents} học sinh. Sử dụng endpoint /clear-students để xóa trước khi seed." });
                }
                ...
                var parentData = new[]
                {
                    new { FatherName = "Nguyễn Văn Hùng", MotherName = "Trần Thị Hằng", Address = "100 Nguyễn Huệ, Quận 1, TP.HCM" },
                    new { FatherName = "Lê Quốc Toàn", MotherName = "Phạm Thị Nga", Address = "101 Lê Lợi, Quận 2, TP.HCM" },
                    new { FatherName = "Hoàng Đình Thắng", MotherName = "Vũ Thị Linh", Address = "102 Điện Biên Phủ, Quận 3, TP.HCM" },
                    new { FatherName = "Đặng Minh Tuấn", MotherName = "Bùi Thị Mai", Address = "103 Cách Mạng Tháng 8, Quận 4, TP.HCM" },
                    new { FatherName = "Phan Văn Dũng", MotherName = "Ngô Thị Thu", Address = "104 Nguyễn Văn Cừ, Quận 5, TP.HCM" },
                    new { FatherName = "Vũ Quang Minh", MotherName = "Đặng Thị Lan", Address = "105 Trần Hưng Đạo, Quận 6, TP.HCM" },
                    new { FatherName = "Bùi Thanh Long", MotherName = "Phan Thị Vân", Address = "106 Lê Văn Sỹ, Quận 7, TP.HCM" },
                    new { FatherName = "Ngô Văn Tùng", MotherName = "Dương Thị Xuân", Address = "107 Võ Văn Tần, Quận 8, TP.HCM" },
                    new { FatherName = "Lý Quốc Bảo", MotherName = "Võ Thị Yến", Address = "108 Hai Bà Trưng, Quận 9, TP.HCM" },
                    new { FatherName = "Trương Minh Thiện", MotherName = "Đinh Thị Oanh", Address = "109 Lý Tự Trọng, Quận 10, TP.HCM" }
                };

                var fatherJobs = new[] { "Kỹ sư", "Bác sĩ", "Luật sư", "Giảng viên", "Kiến trúc sư", "Công nhân", "Tài xế", "Thợ điện", "Nhà báo", "Thầy thuốc" };
                var motherJobs = new[] { "Giáo viên", "Y tá", "Kế toán", "Nhân viên văn phòng", "Dược sĩ", "Bán hàng", "Nội trợ", "May mặc", "Thiết kế", "Điều dưỡng" };
                ...
                for (int i = 0; i < parentData.Length; i++)
                {
                    ...
                    var father = new Parent
                    {
                        ...
                        Email = $"{fatherNameParts[0].ToLower()}{string.Join("", fatherNameParts.Skip(1)).ToLower()}{i + 1}@email.com",
                    ...
                    var mother = new Parent
                    {
                        ...
                        Email = $"{motherNameParts[0].ToLower()}{string.Join("", motherNameParts.Skip(1)).ToLower()}{i + 1}@email.com",
                        Address = data.Address,
                ...
                {
                    new { Name = "Nguyễn Văn An", Gender = "Nam", DOB = new DateOnly(2018, 3, 15) },
                    new { Name = "Trần Thị Lan", Gender = "Nữ", DOB = new DateOnly(2018, 5, 20) },
                    new { Name = "Lê Minh Đức", Gender = "Nam", DOB = new DateOnly(2018, 7, 10) },
                    new { Name = "Phạm Thị Hoa", Gender = "Nữ", DOB = new DateOnly(2018, 2, 28) },
                    new { Name = "Hoàng Quang Huy", Gender = "Nam", DOB = new DateOnly(2018, 9, 12) },
                    new { Name = "Vũ Thị Nga", Gender = "Nữ", DOB = new DateOnly(2018, 4, 18) },
                    new { Name = "Đặng Văn Phúc", Gender = "Nam", DOB = new DateOnly(2018, 11, 25) },
                    new { Name = "Bùi Thị Tâm", Gender = "Nữ", DOB = new DateOnly(2018, 6, 30) },
                    new { Name = "Phan Thanh Sơn", Gender = "Nam", DOB = new DateOnly(2018, 1, 8) },
                    new { Name = "Ngô Thị Phượng", Gender = "Nữ", DOB = new DateOnly(2018, 12, 14) }
                };
        ...
        public async Task<IActionResult> ClearStudentData()
        {
            try
            {
                ...
                await _context.Database.ExecuteSqlRawAsync("UPDATE Class SET CurrentStudentCount = 0");
        ...
        public async Task<IActionResult> CheckData()
        {
            ...
            {
                return StatusCode(500, new { message = "Lỗi khi kiểm tra dữ liệu", error = ex.Message });
            }
        }
    }
} 