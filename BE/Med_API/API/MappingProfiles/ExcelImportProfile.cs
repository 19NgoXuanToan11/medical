...
public class ExcelImportProfile : Profile
{
    public ExcelImportProfile()
    {
        ...
        CreateMap<
            Service.DTOs.ExcelImportDto.StudentParentRow,
            API.DTOs.ExcelImportDto.StudentParentRow
        >();
        CreateMap<
            Service.DTOs.ExcelImportDto.HealthProfileRow,
            API.DTOs.ExcelImportDto.HealthProfileRow
        >();
