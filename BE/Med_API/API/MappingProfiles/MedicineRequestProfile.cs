...
public class MedicineRequestProfile : Profile
{
    public MedicineRequestProfile()
    {
        ...
        CreateMap<MedicineRequest, MedicineRequestDto.ViewModel>()
            ...
            .ForMember(
                dest => dest.MedicineRequestItems,
        ...
        CreateMap<MedicineRequestItem, MedicineRequestItemDto.ViewModel>()
            ...
            .ForMember(
                dest => dest.VerificationStatus,
                opt => opt.MapFrom(src => NormalizeVerificationStatus(src.VerificationStatus))
            )
            .ForMember(
                dest => dest.PeriodVerificationStatus,
                opt =>
                    opt.MapFrom(src =>
                        ParsePeriodVerificationStatus(src.VerificationStatus, src.Period)
                    )
            );
        ...
        CreateMap<MedicineRequestItemDto.Create, MedicineRequestItem>()
            ...
            .ForMember(
                dest => dest.VerificationStatus,
                opt => opt.MapFrom(src => InitPeriodVerificationStatus(src.TimeOfDay))
            );
    ...
    public static Dictionary<string, object> ParsePeriodVerificationStatus(
        string? jsonOrStatus,
