...
public class HealthCheckItemProfile : Profile
{
    public HealthCheckItemProfile()
    {
        ...
        CreateMap<HealthCheckItem, HealthCheckItemDto.ViewModel>()
            .ForMember(dest => dest.RequiredMedicalSupplies, opt => opt.MapFrom(src => src.HealthCheckItemMedicalSupplies));

        // Entity to ListViewModel
        CreateMap<HealthCheckItem, HealthCheckItemDto.ListViewModel>()
            .ForMember(dest => dest.RequiredSuppliesCount, opt => opt.MapFrom(src => src.HealthCheckItemMedicalSupplies.Count));
        ...
        CreateMap<HealthCheckItemDto.Create, HealthCheckItem>()
            ...
            .ForMember(dest => dest.HealthCheckItemMedicalSupplies, opt => opt.MapFrom(src => src.RequiredMedicalSupplies));
        ...
        CreateMap<HealthCheckItemMedicalSupply, HealthCheckItemDto.MedicalSupplyRequirement>()
            .ForMember(dest => dest.MedicalSupplyName, opt => opt.MapFrom(src => src.MedicalSupply != null ? src.MedicalSupply.Name : ""))
            .ForMember(dest => dest.MedicalSupplyCategory, opt => opt.MapFrom(src => src.MedicalSupply != null ? src.MedicalSupply.Category : ""))
            .ForMember(dest => dest.StockQuantity, opt => opt.MapFrom(src => src.MedicalSupply != null ? src.MedicalSupply.StockQuantity : 0))
            .ForMember(dest => dest.IsActive, opt => opt.MapFrom(src => src.MedicalSupply != null ? src.MedicalSupply.IsActive : false));
