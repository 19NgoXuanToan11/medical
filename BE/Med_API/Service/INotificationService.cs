...
public interface INotificationService
{
    ...
    // Special methods for injection consent
    Task<Notification?> CreateInjectionConsentNotificationAsync(int formId, int parentId, string studentName, string injectionName);
    Task<bool> UpdateInjectionConsentNotificationAsync(int formId, string status);
} 