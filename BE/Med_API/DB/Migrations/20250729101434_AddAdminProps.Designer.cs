...
namespace DB.Migrations
{
    ...
    [Migration("20250729101434_AddAdminProps")]
    partial class AddAdminProps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DB.HealthEvent", b =>
                {
                    ...
                    b.Property<string>("InsufficientItems")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InsufficientItemsNote")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DB.HealthEventFollowUp", b =>
                {
                    ...
                    b.ToTable("HealthEventFollowUp", (string)null);
                });
            ...
            modelBuilder.Entity("DB.MedicineRequest", b =>
                {
                    ...
                    b.Property<int?>("AdministrationStartedBy")
                        .HasColumnType("int");

                    b.Property<DateTime?>("AdministrationStartedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DB.HealthEventFollowUp", b =>
                {
                    b.HasOne("DB.HealthEvent", "Event")
                        .WithMany("HealthEventFollowUps")
            ...
            modelBuilder.Entity("DB.HealthEvent", b =>
                {
                    b.Navigation("HealthEventFollowUps");
