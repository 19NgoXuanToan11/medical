        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border-l-4 border-blue-500">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-green-600">+3.5% so với tháng trước</p>
            </div>
          </div>
        </div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${
                          (count /
                            Object.values(stats.healthVisitsByCategory).reduce(
                              (a, b) => a + b,
                              0
                            )) *
                          100
            ...
            <div>
              ...
              <div className="flex justify-between text-sm">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">thời gian trung bình</p>
                </div>
                <div>
