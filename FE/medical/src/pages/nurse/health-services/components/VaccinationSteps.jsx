      ...
      <div className="flex justify-end">
        {isLastStep ? (
          <button
            ...
            className={`inline-flex items-center px-6 py-2 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed ${
              hasErrors || conflictSeverity === "error"
