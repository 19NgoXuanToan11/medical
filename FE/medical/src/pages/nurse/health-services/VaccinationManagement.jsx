...
const VaccinationManagement = () => {
    ...
    const filteredVaccinations = vaccinations.filter((vaccination) => {
        ...
        if (activeSubTab === "scheduled" && vaccination.status !== "scheduled")
            return false;
        if (activeSubTab === "active" && vaccination.status !== "active") return false;
    ...
    const getStats = () => {
        ...
        const totalStudents = vaccinations.reduce((sum, vaccination) => {
            if (vaccination.status === "scheduled" || vaccination.status === "active") {
                    ...
                    <div className="mb-4">
                        ...
                        <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2">
                            <div
                                ...
                                style={{
                                    width: `${Math.round(
                                        (vaccination.completedStudents / vaccination.totalStudents) * 100
                                    )}%`,
                                }}
                            ></div>
                        </div>
    ...
    const renderEmptyState = () => (
        <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-neutral-900 dark:text-neutral-100 mb-2">
                {activeSubTab === "scheduled" && "Không có tiêm chủng nào được lên lịch"}
            ...
            <p className="text-neutral-500 dark:text-neutral-400 mb-6">
                ...
                {activeSubTab === "active" && "Các tiêm chủng đang thực hiện sẽ hiển thị ở đây"}
                {activeSubTab === "completed" && "Lịch sử các tiêm chủng đã hoàn thành sẽ hiển thị ở đây"}
            </p>
                        ...
                        {[
                            {
                                ...
                                label: "Đã lên lịch",
                                icon: FiCalendar,
                                count: vaccinations.filter((v) => v.status === "scheduled").length,
                            },
                            {
                                id: "active",
