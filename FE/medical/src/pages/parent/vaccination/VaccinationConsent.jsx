      ...
      {!submitted ? (
          ...
          <div className="p-6">
            ...
            <div className="bg-white rounded-lg border border-neutral-200 p-6 mb-6">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-neutral-500">Loại vaccine</p>
                  <p className="font-medium">{vaccineInfo.name}</p>
                </div>
                <div>
                  <p className="text-sm text-neutral-500">Ngày tiêm dự kiến</p>
                ...
                <div>
                  <p className="text-sm text-neutral-500">Mô tả vaccine</p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center">
                        ...
                        />
                        <span>
                          Đồng ý cho con tôi được tiêm vaccine{" "}
                          {vaccineInfo.name}
                        </span>
                      </label>
                      <label className="flex items-center">
                  ...
                  {consentGiven === true && (
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        ...
                        <li>
                          Con tôi không có tiền sử dị ứng với vaccine này.
                        </li>
                        <li>
                  ...
                  {consentGiven === false && (
                    <div className="p-4 bg-yellow-50 border-l-4 border-yellow-400">
                      <p className="text-yellow-700">
                        Bạn đã chọn không đồng ý cho con tiêm chủng. Vui lòng
        ...
        <div className="bg-white rounded-lg shadow-sm border border-neutral-100 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-neutral-500">
              Thông tin này đã được gửi đến nhà trường. Bạn có thể đóng trang
              này.
            </p>
          </div>
        </div>
