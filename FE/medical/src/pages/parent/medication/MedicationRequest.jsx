  ...
  const handleChange = (e) => {
    ...
    if (type === "checkbox") {
      if (checked) {
        setFormData({
          ...formData,
          timeOfDay: [...formData.timeOfDay, value],
        });
      } else {
        setFormData({
          ...formData,
          timeOfDay: formData.timeOfDay.filter((time) => time !== value),
        });
      }
    } else if (type === "file") {
      setFormData({
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  ...
                  <label className="flex items-center space-x-2 p-3 border rounded-md hover:bg-gray-50">
                    <input
                      ...
                      name="timeOfDay"
                      value="noon"
                      checked={formData.timeOfDay.includes("noon")}
                      onChange={handleChange}
                      className="h-4 w-4 text-blue-600"
                    />
                    <span>Buổi trưa</span>
                  ...
                  <label className="flex items-center space-x-2 p-3 border rounded-md hover:bg-gray-50">
                    <input
                      ...
                      name="timeOfDay"
                      value="as_needed"
                      checked={formData.timeOfDay.includes("as_needed")}
                      onChange={handleChange}
                      className="h-4 w-4 text-blue-600"
                    />
                    <span>Khi cần</span>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    {formData.medicationImage ? (
                      <div className="flex flex-col items-center">
                        <img
                          src={URL.createObjectURL(formData.medicationImage)}
                          alt="Medication preview"
                          className="max-h-36 mb-2 rounded"
                        />
                        <span className="text-sm text-gray-500">
                          {formData.medicationImage.name}
                        </span>
                        <button
                          type="button"
                          className="mt-2 text-sm text-red-600 hover:text-red-800"
                          onClick={() =>
                            setFormData({ ...formData, medicationImage: null })
                          }
                        >
                          Xóa
                        </button>
