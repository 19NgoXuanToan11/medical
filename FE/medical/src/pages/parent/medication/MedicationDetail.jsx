  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl mt-20">
        <div className="bg-white rounded-lg shadow-sm border border-neutral-100 p-8 flex items-center justify-center h-64">
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl mt-20">
        <div className="bg-white rounded-lg shadow-sm border border-neutral-100 p-8 text-center">
          ...
          <Link
            ...
            className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-black rounded-md transition-colors"
          >
            Quay lại danh sách
          </Link>
        </div>
        ...
        <div className="p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 border border-neutral-300 text-black rounded-md hover:bg-neutral-50 flex items-center gap-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
                  viewBox="0 0 20 20"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-neutral-200 rounded-full h-2.5 mb-1 mt-2">
                      <div
                  ...
                  <div key={index} className="bg-neutral-50 p-4 rounded-md">
                    <div className="flex justify-between mb-2">
                      <div>
                        ...
                        <p className="text-sm text-neutral-500">{note.role}</p>
                      </div>
